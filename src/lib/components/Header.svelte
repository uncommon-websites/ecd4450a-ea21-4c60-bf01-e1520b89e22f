  ...
  <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
    <div class="flex items-center gap-8">
      <a href="/" class="flex items-center gap-2">
        <svg width="28" height="36" viewBox="0 0 90 115" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span class="text-2xl font-bold tracking-tight font-sans">Embat</span>
      </a>
      
      <nav class="hidden md:flex items-center gap-6">
        {#each ["Product", "Integrations", "Security", "Customers", "Company"] as item}
